  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-3">
        <?php include(
'C:\xampp\htdocs\carrental\MVC_pattern\Model\includes\sidebar.php');?>
...
<<!--Footer -->
<?php include(
'C:\xampp\htdocs\carrental\MVC_pattern\Model\includes\footer.php');?>
<!-- /Footer--> 
...
<!--Login-Form -->
<?php include(
'C:\xampp\htdocs\carrental\MVC_pattern\Model\includes\login.php'
);?>
<!--/Login-Form --> 

<!--Register-Form -->
<?php include(
'C:\xampp\htdocs\carrental\MVC_pattern\Model\includes\registration.php');?>

<!--/Register-Form --> 

<!--Forgot-password-Form -->
<?php include(
'C:\xampp\htdocs\carrental\MVC_pattern\Model\includes\forgotpassword.php');?>
<!--/Forgot-password-Form --> 
